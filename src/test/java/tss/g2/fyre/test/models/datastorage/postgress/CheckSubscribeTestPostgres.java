...
public class CheckSubscribeTestPostgres {
    ...
    @Test
    public void testCheckSubscribe() throws SQLException {
        PostgresDataStorage dataStorage = new PostgresDataStorage(properties);
        boolean result = dataStorage.checkSubscribe("test_user2", "test_user1");
