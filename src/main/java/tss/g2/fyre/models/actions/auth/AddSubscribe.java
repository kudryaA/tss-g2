...
public class AddSubscribe implements ActionAuth {
   ...
   */
  public AddSubscribe(DataStorage dataStorage, String sub_login) {
  ...
  public Answer getAnswer(String login, String role) {
    return new Answer<>(true, dataStorage.addSubscribe(login, sub_login));
  }
}
